...
def data_tel_num():
    return [
        {
            "Дата операции": "31.01.2019 17:41:57",
            "Дата платежа": "02.02.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -99.9,
            "Валюта операции": "RUB",
            ...
            "Бонусы (включая кэшбэк)": 1,
            "Округление на инвесткопилку": 0,
            "Сумма операции с округлением": 99.9,
        },
        {
        ...
        {
            "Дата операции": "30.01.2019 20:31:25",
            "Дата платежа": "01.02.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -454.0,
            "Валюта операции": "RUB",
            "Сумма платежа": -454.0,
            "Валюта платежа": "RUB",
            "Кэшбэк": 0,
            ...
            "Округление на инвесткопилку": 0,
            "Сумма операции с округлением": 454.0,
        },
        {
        ...
        {
            "Дата операции": "30.01.2019 18:19:22",
            "Дата платежа": "01.02.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -607.98,
            "Валюта операции": "RUB",
            "Сумма платежа": -607.98,
            "Валюта платежа": "RUB",
            "Кэшбэк": 0,
            "Категория": "Супермаркеты",
            "MCC": 5411.0,
            ...
            "Округление на инвесткопилку": 0,
            "Сумма операции с округлением": 607.98,
        },
        {
            "Дата операции": "30.01.2019 14:46:11",
            "Дата платежа": "01.02.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -49.0,
        ...
        {
            "Дата операции": "30.01.2019 14:19:24",
            "Дата платежа": "01.02.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -49.0,
        ...
        {
            "Дата операции": "29.01.2019 00:00:00",
            "Дата платежа": "29.01.2019",
            "Номер карты": 0,
            "Статус": "OK",
            "Сумма операции": -59.0,
            "Валюта операции": "RUB",
            ...
            "MCC": 0,
            "Описание": "Плата за оповещения об операциях",
            "Бонусы (включая кэшбэк)": 0,
            "Округление на инвесткопилку": 0,
            "Сумма операции с округлением": 59.0,
        },
        {
            "Дата операции": "28.01.2019 17:42:07",
            "Дата платежа": "30.01.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -93.9,
            ...
            "Бонусы (включая кэшбэк)": 1,
            "Округление на инвесткопилку": 0,
            "Сумма операции с округлением": 93.9,
        },
        {
            "Дата операции": "28.01.2019 17:34:46",
            "Дата платежа": "30.01.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -137.7,
            "Валюта операции": "RUB",
            "Сумма платежа": -137.7,
            "Валюта платежа": "RUB",
            "Кэшбэк": 0,
            ...
            "Бонусы (включая кэшбэк)": 2,
            "Округление на инвесткопилку": 0,
            "Сумма операции с округлением": 137.7,
        },
        {
            "Дата операции": "28.01.2019 16:57:45",
            "Дата платежа": "30.01.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -122.2,
            "Валюта операции": "RUB",
            "Сумма платежа": -122.2,
            "Валюта платежа": "RUB",
            "Кэшбэк": 0,
            ...
            "Бонусы (включая кэшбэк)": 2,
            "Округление на инвесткопилку": 0,
            "Сумма операции с округлением": 122.2,
        },
        {
            "Дата операции": "28.01.2019 16:54:49",
            "Дата платежа": "30.01.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -95.7,
            ...
            "Бонусы (включая кэшбэк)": 1,
            "Округление на инвесткопилку": 0,
            "Сумма операции с округлением": 95.7,
        },
        {
        ...
        {
            "Дата операции": "28.01.2019 12:04:53",
            "Дата платежа": "28.01.2019",
            "Номер карты": 0,
            "Статус": "OK",
            "Сумма операции": -5.0,
            ...
            "Категория": "Услуги банка",
            "MCC": 0,
            "Описание": "Комиссия за операцию",
            "Бонусы (включая кэшбэк)": 0,
            "Округление на инвесткопилку": 0,
            "Сумма операции с округлением": 5.0,
        },
        {
            "Дата операции": "27.01.2019 19:00:25",
            "Дата платежа": "28.01.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -331.07,
            "Валюта операции": "RUB",
            "Сумма платежа": -331.07,
            "Валюта платежа": "RUB",
            "Кэшбэк": 0,
            "Категория": "Супермаркеты",
            "MCC": 5411.0,
            ...
            "Бонусы (включая кэшбэк)": 6,
            "Округление на инвесткопилку": 0,
            "Сумма операции с округлением": 331.07,
        },
        {
            "Дата операции": "27.01.2019 11:15:33",
            "Дата платежа": "30.01.2019",
            "Номер карты": "*7197",
            "Статус": "OK",
